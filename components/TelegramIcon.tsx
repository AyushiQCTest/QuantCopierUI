...
export function TelegramIcon({ theme = "dark", ...props }: TelegramIconProps) {
    ...
    >
      <defs>
        <linearGradient id="logosTelegram" x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor={theme === "dark" ? "#2AABEE" : "#FFFFFF"} />
          <stop offset="100%" stopColor={theme === "dark" ? "#229ED9" : "#FFFFFF"} />
        </linearGradient>
      </defs>
      <path
        fill={`url(#logosTelegram${theme === "dark" ? "Dark" : "Light"})`}
