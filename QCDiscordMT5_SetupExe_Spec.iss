...
#define MyAppName "QuantCopierMT5Discord"
#define MyAppVersion "1.0"
#define MyAppPublisher "QuantTraderTools"
#define MyAppURL "QuantTraderTools.com"
#define MyAppExeName "QuantCopierMT5Discord.exe"
...
OutputBaseFilename=QuantCopierMT5DiscordSetup
SetupIconFile={#ParentPath}\src-tauri\icons\QuantCopierMT5DiscordSetup.ico
Compression=lzma
...
[Files]
Source: "{#ParentPath}\src-tauri\target\release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "{#ParentPath}\..\qcdemo\dist\QuantCopierDiscord.exe"; DestDir: "{app}"; Flags: ignoreversion
